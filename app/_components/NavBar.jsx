...
},
{
    ...
    {/* <div className=' hidden  sm:flex flex-col gap-y-7 border-r-3 border-white'> */}
            ...
            <div>
                <button className='px-14 cursor-pointer rounded-full text-2xl  py-3 bg-white text-black hidden lg:block'>Post</button>
                <div className='h-8 w-8 rounded-full bg-white  hidden lg:block'></div>
            </div>
